...
const CERTIFICATES = [
  { title: "CS50x: Computer Science", issuer: "Harvard University (edX)", year: "2024", id: "CS50x" },
  { title: "Google Cloud Computing Foundations", issuer: "Google Cloud / edX", year: "2024", id: "GCCF1x" },
  { title: "Fundamentals of Digital Marketing", issuer: "Google Digital Garage", year: "2019", id: "Digital Mrkt" },
  { title: "Einstieg Programmierung (C++/C#/Java)", issuer: "Klubschule Migros", year: "2019", id: "Basics" },
  { title: "Multicheck ICT", issuer: "Gateway.one", year: "2019", id: "Aptitude" },
];
...
const MakeLogo = () => (
  <img src={makeLogo} alt="Make.com" className="w-5 h-5 object-contain mr-2 rounded-sm" />
);
    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-teal-500/30">
      ...
      <div className="lg:fixed lg:left-0 lg:top-0 lg:h-full lg:w-72 bg-slate-900 border-r border-slate-800 flex flex-col z-20">
        <div className="p-8 border-b border-slate-800">
          <div className="relative w-24 h-24 mx-auto bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-4 shadow-lg shadow-teal-900/20 overflow-hidden group cursor-pointer border-4 border-slate-800">
             <img 
               src={profileImg} 
               alt="Flavio Paesano" 
        ...
        {activeTab === 'overview' && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="mt-8 flex gap-4">
               <button onClick={() => setActiveTab('experience')} className="px-6 py-3 bg-white text-slate-900 font-bold rounded-lg hover:bg-slate-200 transition-colors flex items-center gap-2">
                 Erfahrung ansehen <ChevronRight size={18} />
               </button>
               <button onClick={() => window.print()} className="px-6 py-3 border border-slate-700 text-white font-medium rounded-lg hover:bg-slate-800 transition-colors">
                 Als PDF drucken
               </button>
            </div>
          </div>
               ...
               {CERTIFICATES.map((cert, index) => (
                 <Card key={index} className="flex flex-col h-full bg-slate-800/30">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-700/50 flex justify-between items-center">
                       ...
                       <span className="text-xs text-slate-400 flex items-center gap-1"><Award size={12}/> Verified</span>
                    </div>
                 </Card>
               ))}
             </div>
